                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                <div class="media d-flex" style="display: inline">
                                    <h2><a style="z-index:3; position:relative;" href="/<?php echo '@'.$post->user->username ?>"><img style="border-radius: 50%" src="https://itcsvc.kku.edu.sa/KKU_MyKkuWS/UserImage?nickname={{ $post->user->username }}" class="mr-3" height="45"></a></h2>
                                    <div class="media-body mb-3" style="margin-right: 10px; weidth:10px">
                                        <a style="z-index:3; position:relative; color: #212529; text-decoration: none;" href="/<?php echo '@'.$post->user->username ?>">
                                        <h5 class="mt-1 mb-0">{{ $post->user->name }}</h5></a>
                                        <span class="text-muted mt-0" style="font-size: 13px">{{ $post->user->username }}@</span>
                                    </div>
                                </div>
